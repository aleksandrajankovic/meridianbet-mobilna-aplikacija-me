...
function redirectToApp() {
  ...
  if (md.is("iPhone") || md.is("iPad") || md.is("iPod")) {
    window.location.href = "https://itunes.apple.com/hr/app/id1145886114";
  } else if (md.is("AndroidOS")) {
    window.location.href =
      "https://coupons.joker.co.rs/~android/me/app-me-release.apk";
  } else if (md.is("Huawei")) {
    window.location.href = "https://appgallery.huawei.com/#/app/C104645847";
  } else {
